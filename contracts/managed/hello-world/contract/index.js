...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.userAge) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named userAge');
    }
  ...
  _userAge_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.userAge(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 255n)) {
      __compactRuntime.typeError('userAge',
                                 'return value',
                                 'hello-world.compact line 11 char 1',
                                 'Uint<0..256>',
                                 result_0)
    }
  ...
  _verifyEligibility_0(context, partialProofData) {
    const age_0 = this._userAge_0(context, partialProofData);
    const tmp_0 = age_0 >= 18n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
...
const _dummyContract = new Contract({ userAge: (...args) => undefined });
